        ...
        var parseEngine = {
            ...
            "u17.com": function() {
                ...
                getImgURL = function(thePage) {
                    ...
                    return (/src="([^"]*)"/)
                        .exec(eee((/document.write\(eee\('([^']*)'/)
                            .exec(request.responseText)[1]))[1];
                };
                setCurrentPage = function(thePage) {
                    u_page = thePage;
                };
                ...
                if (!_window.__htmlURL) {
                    u_page = 0;
                    __htmlURL = [];
                    var UrlBase = document.body.innerHTML.substr(document.body.innerHTML.indexOf("$('#comicShow')"))
                        .match(/location.href=(.*?)\+\$\("#comicShow"\).*?;/)[1];
                    for (var i = 0; i < $_('comicShow')
                        .options.length; ++i) {
                        __htmlURL.push(eval(UrlBase) + $_('comicShow')
                            .options[i].value + '.html');
                        if ($_('comicShow')
                            .options[i].selected)
                            u_page = i;
                    }
                ...
                try {
                    ...
                    var nextUrl = String(btns[0].onclick)
                        .match(/href='(.*?)'/);
                    if (nextUrl)
                        ChapterInfo.next = {
                            text: "",
                    ...
                    var prevUrl = String(btns[1].onclick)
                        .match(/href='(.*?)'/);
                    if (prevUrl)
                        ChapterInfo.prev = {
                            text: "",
            ...
            "comic.131.com/content/": function() {
                ...
                if (!_window._chapterInfo) {
                    ...
                    _window._chapterInfo = {
                        next: chapterlinks[2] ? {
                            text: chapterlinks[2].innerText,
                            href: chapterlinks[2].href
                        } : false,
                        prev: chapterlinks[1] ? {
                            text: chapterlinks[1].innerText,
                            href: chapterlinks[1].href
                        } : false
                    };
                }
            ...
            "*.xindm.cn/display.asp": function() {
                    ...
                    getImgURL = function(thePage) {
                        ...
                        return tmpDiv.querySelector("table tbody tr td table tbody tr td table tbody tr td table tbody tr td img")
                            .src;
            ...
            "www.dmeden.com/comichtml": function() {
                var PageCount = parseInt(document.getElementById("hdPageCount")
                    .value, 10);
                var CurrentPage = parseInt(document.getElementById("hdPageIndex")
                    .value, 10) - 1;
                var __sID = document.getElementById("hdVolID")
                    .value;
                var __s = document.getElementById("hdS")
                    .value;
                getCurrentPage = function() {
                    return CurrentPage;
                };
            ...
            "www.kkkmh.com/manhua": function() {
                ...
                Array.prototype.forEach.call($("chapter-func")
